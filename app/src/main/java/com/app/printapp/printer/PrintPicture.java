package com.app.printapp.printer;
...
public class PrintPicture {
	public static int PAPER_WIDTH1= 384;
	public static int PAPER_WIDTH2= 576;
	...
	private static void Print_BMP(WifiCommunication wfComm, Bitmap bitmap,int paperWidth){

		byte[] buffer = PrinterCommand.POS_Set_PrtInit();
		Bitmap mBitmap = bitmap;
		int nMode = 0;
		int nPaperWidth = paperWidth;
